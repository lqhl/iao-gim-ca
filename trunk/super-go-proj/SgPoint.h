...
#else
    poco_static_assert(SG_DEFINE_MAX_SIZE >= SG_MIN_SIZE);
    poco_static_assert(SG_DEFINE_MAX_SIZE <= 25);
...
#define SG_ASSERTRANGE(i, from, to) poco_assert(i >= from && i <= to)
